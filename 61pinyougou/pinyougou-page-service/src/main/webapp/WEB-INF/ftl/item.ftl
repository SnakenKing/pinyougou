...
<head>
    ...
    <script>
        var skuList=[
            ...
            <#list skuList as sku>
                {"id":${sku.id?c},"title":"${sku.title}","price":${sku.price},"spec":${sku.spec}},
            </#list>
        ]
    </script>
                    ...
                    <div id="specification" class="summary-wrap clearfix">
                      ...
                      <#list specificationList as specification>
                        <dl>
                            ...
                            <#list specification.attributeValue as attribute>
                                <dd >
                                    <#-- <a href="javascript:;" class="selected">金色<span title="点击取消选择">&nbsp;</span></a>-->
                                    <a href="javascript:;" :class="{selected:isSelected('${specification.attributeName}','${attribute}')}" @click="selectSpecifcation('${specification.attributeName}','${attribute}')" >${attribute}<span title="点击取消选择">&nbsp;</span></a>
                                </dd>
                            </#list>
                        </dl>
                      </#list>
